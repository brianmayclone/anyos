...
impl LanguageId {
    ...
    pub fn block_comment(&self) -> Option<(&'static str, &'static str)> {
        match self {
            Self::Rust | Self::C | Self::Cpp | Self::JavaScript
            | Self::TypeScript | Self::Css => Some(("/*", "*/")),
...
static LANG_RUST: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "pub", "use", "mod", "crate", "self", "super", "extern", "type", "where",
        "if", "else", "match", "for", "while", "loop", "break", "continue", "return",
        "async", "await", "move", "unsafe", "dyn", "ref", "as", "in",
...
static LANG_C: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "NULL", "stdin", "stdout", "stderr", "FILE", "size_t", "uint8_t", "uint16_t",
...
static LANG_CPP: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "bool", "true", "false", "auto", "decltype", "constexpr", "noexcept",
        "try", "catch", "throw", "using", "operator", "friend", "mutable",
...
static LANG_PYTHON: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "raise", "with", "pass", "lambda", "global", "nonlocal", "assert", "del",
        "True", "False", "None", "and", "or", "not", "in", "is",
        "self", "cls", "super", "print", "len", "range", "enumerate", "zip",
...
static LANG_TYPESCRIPT: LanguageInfo = LanguageInfo {
    ...
    filenames: &[],
    keywords: &[
        "interface", "type", "enum", "namespace", "declare", "module",
        "abstract", "implements", "readonly", "private", "protected", "public",
        "keyof", "infer", "extends", "as", "is", "in", "out",
...
static LANG_SHELL: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "echo", "printf", "read", "local", "export", "unset", "shift",
        "test", "true", "false", "set", "source", "eval",
        "cd", "ls", "cp", "mv", "rm", "mkdir", "chmod", "chown",
        "grep", "sed", "awk", "find", "sort", "cut", "tr", "wc",
        "cat", "head", "tail", "tee", "xargs", "pipe",
    ],
    snippets: &[
        ("if", "if [ ${1:cond} ]; then\n    ${0}\nfi"),
...
static LANG_MAKEFILE: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "all", "clean", "install", "test", "check", "dist",
        "CC", "CXX", "CFLAGS", "CXXFLAGS", "LDFLAGS", "LIBS",
        "AR", "ARFLAGS", "RM", "MAKE", "SHELL",
        "$(wildcard", "$(patsubst", "$(foreach", "$(if", "$(call",
        "$(shell", "$(dir", "$(notdir", "$(basename", "$(suffix",
        "@", "$@", "$<", "$^", "$?", "$*",
    ],
    snippets: &[
...
static LANG_CSS: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "background", "color", "font", "text", "flex", "grid", "align", "justify",
        "overflow", "opacity", "transform", "transition", "animation",
        "none", "block", "inline", "flex", "grid", "absolute", "relative", "fixed",
...
static LANG_ASSEMBLY: LanguageInfo = LanguageInfo {
    ...
    keywords: &[
        ...
        "je", "jne", "jz", "jnz", "jg", "jl", "jge", "jle", "cmp", "test",
        "and", "or", "xor", "not", "shl", "shr", "lea", "nop", "int", "iret",
        "section", "global", "extern", "db", "dw", "dd", "dq", "equ", "times",
...
static LANG_LINKER_SCRIPT: LanguageInfo = LanguageInfo {
    ...
    filenames: &[],
    keywords: &[
        "SECTIONS", "MEMORY", "ENTRY", "PROVIDE", "ALIGN", "AT", "LOADADDR",
...
static ALL_LANGUAGES: &[&LanguageInfo] = &[
    &LANG_RUST, &LANG_C, &LANG_CPP, &LANG_PYTHON,
    &LANG_JAVASCRIPT, &LANG_TYPESCRIPT, &LANG_SHELL, &LANG_MAKEFILE,
    &LANG_JSON, &LANG_TOML, &LANG_YAML, &LANG_XML,
    &LANG_HTML, &LANG_CSS, &LANG_MARKDOWN, &LANG_ASSEMBLY,
    &LANG_LINKER_SCRIPT, &LANG_INI, &LANG_PLAIN_TEXT,
];
