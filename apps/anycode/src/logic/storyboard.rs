...
pub use crate::logic::designer::UiCodeTarget;
use crate::util::path;
...
impl StoryboardDocument {
    ...
    pub fn designer_js(&self) -> String {
        ...
        out.push_str("const SCENES = [\n");
        for scene in &self.scenes {
            out.push_str(&format!(
                "  {{ formName: \"{}\", designerPath: \"{}\", x: {}, y: {} }},\n",
                escape_js(&scene.form_name),
                escape_js(&scene.designer_path),
                scene.x,
                scene.y
            ));
        }
        ...
        for segue in &self.segues {
            out.push_str(&format!(
                "  {{ id: \"{}\", fromForm: \"{}\", fromControl: \"{}\", triggerEvent: \"{}\", toForm: \"{}\", condition: \"{}\", navigationMode: \"{}\", handler: \"{}\" }},\n",
                escape_js(&segue.id),
                escape_js(&segue.from_form),
                escape_js(&segue.from_control),
                escape_js(&segue.trigger_event),
                escape_js(&segue.to_form),
                escape_js(&segue.condition),
                escape_js(&segue.navigation_mode),
    ...
    pub fn codebehind_js(&self) -> String {
        let mut out = String::from(
            "// Generated by anyCode Storyboard Designer. Keep custom logic in hooks.\n\n",
        );
        out.push_str("function storyboardTarget(segueId) {\n  switch (segueId) {\n");
        for segue in &self.segues {
            out.push_str(&format!(
                "    case \"{}\": return \"{}\";\n",
                escape_js(&segue.id),
        ...
        out.push_str("function storyboardCanNavigate(segueId) {\n  switch (segueId) {\n");
        for segue in &self.segues {
            if segue.condition.is_empty() {
                out.push_str(&format!(
                    "    case \"{}\": return true;\n",
...
pub fn save_storyboard(file_path: &str, doc: &StoryboardDocument) -> Result<(), &'static str> {
    save_storyboard_for_target(file_path, doc, infer_target(file_path))
}

pub fn save_storyboard_for_target(
    file_path: &str,
    ...
    regenerate_generated_files_for_target(file_path, &normalized, target)
}
...
pub fn designer_js_path(storyboard_path: &str) -> String {
    format!("{}.Designer.js", storyboard_path)
}

pub fn codebehind_js_path(storyboard_path: &str) -> String {
    format!("{}.codebehind.js", storyboard_path)
}
...
pub fn regenerate_generated_files(
    ...
    regenerate_generated_files_for_target(storyboard_path, doc, infer_target(storyboard_path))
}
...
pub fn regenerate_generated_files_for_target(
    ...
    match target {
        ...
        UiCodeTarget::Node => {
            anyos_std::fs::write_bytes(
                &designer_js_path(storyboard_path),
                doc.designer_js().as_bytes(),
            )
            .map_err(|_| "Could not write storyboard designer code")?;
            anyos_std::fs::write_bytes(
                &codebehind_js_path(storyboard_path),
...
pub fn ensure_startup_main(
    ...
    ensure_startup_main_for_target(project_root, storyboard_path, UiCodeTarget::Rust)
}

pub fn ensure_startup_main_for_target(
    project_root: &str,
    storyboard_path: &str,
    target: UiCodeTarget,
) -> Result<bool, &'static str> {
    if target == UiCodeTarget::Node {
        return ensure_startup_main_js(project_root, storyboard_path);
    }
...
fn startup_main_js(
    ...
    let ui_struct = format!("{}Ui", form_name);
    format!(
        "const ui = require('@anyos/anyui');\nconst formModule = require('./ui/{}');\nconst viewModule = require('./ui/{}/view');\nconst designerModule = require('./ui/{}/designer');\n\nconst STARTUP_STORYBOARD = \"{}\";\n\nfunction GeneratedAnyCodeForm(uiBuilder) {{\n  this.ui = uiBuilder.build();\n}}\n\nGeneratedAnyCodeForm.prototype.root = function() {{\n  return this.ui && this.ui.root;\n}};\n\nfunction createForm() {{\n  if (viewModule && typeof viewModule.{} === 'function') {{\n    return new viewModule.{}();\n  }}\n  if (typeof viewModule === 'function') {{\n    return new viewModule();\n  }}\n  if (formModule && typeof formModule.{} === 'function') {{\n    return new formModule.{}();\n  }}\n  if (typeof formModule === 'function') {{\n    return new formModule();\n  }}\n  if (designerModule && designerModule.{} && typeof designerModule.{}.build === 'function') {{\n    return new GeneratedAnyCodeForm(designerModule.{});\n  }}\n  if (formModule && formModule.{} && typeof formModule.{}.build === 'function') {{\n    return new GeneratedAnyCodeForm(formModule.{});\n  }}\n  throw new TypeError(\"Generated form '{}' did not export a constructor\");\n}}\n\nfunction main() {{\n  const form = createForm();\n  const root = form.root();\n  if (!root) {{\n    throw new Error(\"Generated form '{}' did not return a root view\");\n  }}\n  root.setDock(ui.DOCK_FILL);\n\n  const win = new ui.Window(\"{}\", -1, -1, {}, {});\n  win.add(root);\n\n  void STARTUP_STORYBOARD;\n  ui.run();\n}}\n\nmain();\n",
...
fn infer_target(storyboard_path: &str) -> UiCodeTarget {
    if let Some(root) = project_root_for(storyboard_path) {
        if path::exists(&format!("{}/package.json", root)) {
