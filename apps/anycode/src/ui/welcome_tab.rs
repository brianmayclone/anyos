...
impl WelcomeTab {
    pub fn new() -> Self {
        ...
        title.set_position(60, 24);
        title.set_font_size(28);
        title.set_text_color(tc.text);
        panel.add(&title);

        let subtitle = ui::Label::new("Professional IDE for anyOS");
        subtitle.set_position(62, 60);
        ...
        start_label.set_position(60, 100);
        ...
        feat_label.set_position(340, 100);
