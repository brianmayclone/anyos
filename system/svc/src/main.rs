...
const SVC_DEFAULTS: &[libconf_schema::DefaultEntry<'static>] = &[
    default_string("asld/config/exec", "/System/bin/asld"),
    default_string("asld/config/args", ""),
    default_bool("asld/config/enabled", true),
    default_string("asld/config/depends", ""),
    default_string(
        "asld/config/wants",
        "aslnetd,aslfsd,aslconsoled,aslobsd,logd",
    ),
    default_string(
        "asld/config/after",
        "aslnetd,aslfsd,aslconsoled,aslobsd,logd",
    ),
    default_int("asld/config/startup_timeout_ms", 5000),
    default_string("aslconsoled/config/exec", "/System/bin/aslconsoled"),
    default_string("aslconsoled/config/args", ""),
    default_bool("aslconsoled/config/enabled", true),
    default_string("aslconsoled/config/depends", ""),
    default_string("aslconsoled/config/wants", "logd"),
    default_string("aslconsoled/config/after", "logd"),
    default_int("aslconsoled/config/startup_timeout_ms", 5000),
    default_string("aslfsd/config/exec", "/System/bin/aslfsd"),
    default_string("aslfsd/config/args", ""),
    default_bool("aslfsd/config/enabled", true),
    default_string("aslfsd/config/depends", ""),
    default_string("aslfsd/config/wants", "logd"),
    default_string("aslfsd/config/after", "logd"),
    default_int("aslfsd/config/startup_timeout_ms", 5000),
    default_string("aslnetd/config/exec", "/System/bin/aslnetd"),
    default_string("aslnetd/config/args", ""),
    default_bool("aslnetd/config/enabled", true),
    default_string("aslnetd/config/depends", ""),
    default_string("aslnetd/config/wants", "networkd,dnsd,logd"),
    default_string("aslnetd/config/after", "networkd,dnsd,logd"),
    default_int("aslnetd/config/startup_timeout_ms", 5000),
    default_string("aslobsd/config/exec", "/System/bin/aslobsd"),
    default_string("aslobsd/config/args", ""),
    default_bool("aslobsd/config/enabled", true),
    default_string("aslobsd/config/depends", ""),
    default_string("aslobsd/config/wants", "logd"),
    default_string("aslobsd/config/after", "logd"),
    default_int("aslobsd/config/startup_timeout_ms", 5000),
    ...
    default_string("lxed/config/exec", "/System/bin/lxed"),
    default_string("lxed/config/args", ""),
    default_bool("lxed/config/enabled", true),
    default_string("lxed/config/depends", ""),
    default_string("lxed/config/wants", "logd"),
    default_string("lxed/config/after", "logd"),
    default_int("lxed/config/startup_timeout_ms", 5000),
