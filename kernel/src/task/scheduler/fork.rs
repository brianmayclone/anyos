...
pub fn current_thread_fork_snapshot() -> Option<ForkSnapshot> {
    ...
    Some(ForkSnapshot {
        ...
        uid: thread.uid,
        gid: thread.gid,
        linux_real_uid: thread.linux_real_uid,
        linux_saved_uid: thread.linux_saved_uid,
        linux_fs_uid: thread.linux_fs_uid,
        linux_real_gid: thread.linux_real_gid,
        linux_saved_gid: thread.linux_saved_gid,
        linux_fs_gid: thread.linux_fs_gid,
