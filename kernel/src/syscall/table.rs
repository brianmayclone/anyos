...
pub const SYSCALL_TABLE: &[(u32, &str)] = &[
    ...
    (SYS_WIFI, "wifi"),
    (SYS_NET_PING6, "net_ping6"),
    (SYS_NET_DNS6, "net_dns6"),
    (SYS_UDP_SENDTO_V6, "udp_sendto_v6"),
    (SYS_TCP_CONNECT_V6, "tcp_connect_v6"),
    (SYS_UDP_RECVFROM_V6, "udp_recvfrom_v6"),
    (SYS_TCP_ACCEPT_V6, "tcp_accept_v6"),
