...
pub fn sys_sigreturn_32(regs: &mut super::SyscallRegs) -> u32 {
...
pub fn deliver_pending_signal_32(regs: &mut super::SyscallRegs, syscall_result: u32) {
...
// =========================================================================
// Disk / Partition management (SYS_DISK_*)
// =========================================================================
