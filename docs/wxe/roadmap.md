...
- Plain `wxe init` never silently downloads Microsoft binaries. `wxe init
  --bootstrap-ms --accept-microsoft-licenses` and `wxe bootstrap-ms
  --accept-microsoft-licenses` are explicit Microsoft payload download paths.
