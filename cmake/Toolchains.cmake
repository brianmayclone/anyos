...
add_custom_command(
  ...
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${LIBC_DIR} clean CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${LIBC_DIR} CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC}
  DEPENDS
    ${LIBC_DIR}/Makefile
    ${LIBC_DIR}/src/crt0.S
...
add_custom_command(
  OUTPUT ${DOOM_ELF}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${DOOM_DIR} clean CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${DOOM_DIR} CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC} LIBC_DIR=${LIBC_DIR}
...
add_custom_command(
  OUTPUT ${QUAKE_ELF}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${QUAKE_DIR} clean CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${QUAKE_DIR} CC=${I686_ELF_GCC} AR=${I686_ELF_AR} AS=${I686_ELF_GCC} LIBC_DIR=${LIBC_DIR}
...
add_custom_command(
  OUTPUT ${TINYGL_A}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${TINYGL_DIR} clean CC=${I686_ELF_GCC} AR=${I686_ELF_AR}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${TINYGL_DIR} CC=${I686_ELF_GCC} AR=${I686_ELF_AR} LIBC_DIR=${LIBC_DIR}
...
add_custom_command(
  OUTPUT ${GLCUBE_ELF}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${GLCUBE_DIR} clean CC=${I686_ELF_GCC}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${GLCUBE_DIR} CC=${I686_ELF_GCC} LIBC_DIR=${LIBC_DIR} TINYGL_DIR=${TINYGL_DIR}
...
if(EXISTS "${CLASSICUBE_DIR}/src/Core.h")
  ...
  add_custom_command(
    ...
    COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -C ${CLASSICUBE_DIR} -f misc/anyos/Makefile clean
    COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${CLASSICUBE_DIR} -f misc/anyos/Makefile CC=${I686_ELF_GCC} LIBC_DIR=${LIBC_DIR}
...
add_custom_command(
  ...
  COMMAND ${CLANG_ENV} ${MAKE_EXECUTABLE} -C ${LIBC64_DIR} clean CC=${CLANG_EXECUTABLE} AR=${LLVM_AR_EXECUTABLE} AS=${CLANG_EXECUTABLE}
  COMMAND ${CLANG_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${LIBC64_DIR} CC=${CLANG_EXECUTABLE} AR=${LLVM_AR_EXECUTABLE} AS=${CLANG_EXECUTABLE}
  DEPENDS
    ${LIBC64_DIR}/Makefile
...
add_custom_command(
  OUTPUT ${LIBCXX_A}
  COMMAND ${CLANG_ENV} ${MAKE_EXECUTABLE} -C ${LIBCXX_DIR} clean CXX=${CLANGXX_EXECUTABLE} AR=${LLVM_AR_EXECUTABLE}
  COMMAND ${CLANG_ENV} ${MAKE_EXECUTABLE} -j${NPROC} -C ${LIBCXX_DIR} CXX=${CLANGXX_EXECUTABLE} AR=${LLVM_AR_EXECUTABLE}
  DEPENDS
    ${LIBC64_A}
    ${LIBCXX_DIR}/Makefile
