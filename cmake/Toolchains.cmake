...
add_custom_command(
  OUTPUT ${TINYGL_A}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -s -C ${TINYGL_DIR} clean CC=${I686_ELF_GCC} AR=${I686_ELF_AR}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -s -j${NPROC} -C ${TINYGL_DIR} CC=${I686_ELF_GCC} AR=${I686_ELF_AR} LIBC_DIR=${LIBC_DIR}
...
add_custom_command(
  OUTPUT ${GLCUBE_ELF}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -s -C ${GLCUBE_DIR} clean CC=${I686_ELF_GCC}
  COMMAND ${CROSS_ENV} ${MAKE_EXECUTABLE} -s -j${NPROC} -C ${GLCUBE_DIR} CC=${I686_ELF_GCC} LIBC_DIR=${LIBC_DIR} TINYGL_DIR=${TINYGL_DIR}
