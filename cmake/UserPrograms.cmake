...
file(MAKE_DIRECTORY "${SYSROOT_DIR}/tmp")
...
function(add_app_in_folder NAME SRC_DIR DISPLAY_NAME SUBDIR)
  ...
  foreach(_RESDIR syntax resources assets)
...
add_rust_user_program(time)
add_rust_user_program(hostname)
add_rust_user_program(ftp)
add_rust_user_program(wget)
add_rust_user_program(speedtest)
add_rust_user_program(tcpstress)
add_rust_user_program(httpstress)
add_rust_user_program(lxediag)
add_rust_user_program(vfsstress)
...
add_rust_user_program(swapon)
add_rust_user_program(swapoff)
...
add_rust_user_program(asld)
add_rust_user_program(aslconsoled)
...
if(NOT ANYOS_ARCH STREQUAL "arm64")
  add_app_in_folder(lxeshell ${CMAKE_SOURCE_DIR}/apps/lxeshell "LXE Shell" "Management")
endif()
