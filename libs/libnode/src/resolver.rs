...
pub fn core_module_canonical_name(specifier: &str) -> Option<&'static str> {
    match specifier {
        ...
        "@anyos/confd" => Some("@anyos/confd"),
        "@anyos/db" => Some("@anyos/db"),
        "@anyos/gl" => Some("@anyos/gl"),
        "@anyos/image" => Some("@anyos/image"),
        "confd" | "node:confd" => Some("confd"),
        "db" | "node:db" => Some("db"),
        "gl" | "node:gl" => Some("gl"),
        "node:anyos-ffi" => Some("node:anyos-ffi"),
        "node:anyos-confd" => Some("node:anyos-confd"),
        "node:anyos-db" => Some("node:anyos-db"),
        "node:anyos-gl" => Some("node:anyos-gl"),
