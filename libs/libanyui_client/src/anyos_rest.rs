...
struct AnyuiLib {
    ...
    textfield_set_read_only: extern "C" fn(u32, u32),
    textfield_set_cursor: extern "C" fn(u32, u32),
    textfield_get_cursor: extern "C" fn(u32) -> u32,
    textfield_set_selection: extern "C" fn(u32, u32, u32),
    ...
    datagrid_set_row_indents: extern "C" fn(u32, *const u16, u32),
    datagrid_set_indent_column: extern "C" fn(u32, u32),
    ...
    treeview_get_hovered: extern "C" fn(u32) -> u32,
...
pub fn init() -> bool {
    ...
    unsafe {
        let lib = AnyuiLib {
            ...
            textfield_set_read_only: resolve(&handle, "anyui_textfield_set_read_only"),
            textfield_set_cursor: resolve(&handle, "anyui_textfield_set_cursor"),
            textfield_get_cursor: resolve(&handle, "anyui_textfield_get_cursor"),
            textfield_set_selection: resolve(&handle, "anyui_textfield_set_selection"),
            ...
            datagrid_set_row_indents: resolve(&handle, "anyui_datagrid_set_row_indents"),
            datagrid_set_indent_column: resolve(&handle, "anyui_datagrid_set_indent_column"),
            ...
            treeview_get_hovered: resolve(&handle, "anyui_treeview_get_hovered"),
