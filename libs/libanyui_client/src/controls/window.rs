use crate::events::{ClickEvent, EventArgs};
use crate::KeyEvent;
use crate::{
    events, lib, Container, Control, Widget, EVENT_BLUR, EVENT_CLOSE, EVENT_FOCUS,
    EVENT_FULLSCREEN_ENTER, EVENT_FULLSCREEN_EXIT, EVENT_KEY, EVENT_KEY_UP, EVENT_RESIZE,
    KIND_WINDOW,
};
