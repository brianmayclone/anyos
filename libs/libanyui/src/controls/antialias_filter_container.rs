//! AntiAliasFilterContainer — renders its subtree offscreen and softens hard edges.

use crate::control::{Control, ControlBase, ControlKind};

pub struct AntiAliasFilterContainer {
...
impl Control for AntiAliasFilterContainer {
