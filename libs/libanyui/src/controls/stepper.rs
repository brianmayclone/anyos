...
impl Control for Stepper {
    ...
    fn render(&self, surface: &crate::draw::Surface, ax: i32, ay: i32) {
        ...
        let palette = crate::controls::chrome::neutral_palette(ctx.hovered, false, ctx.disabled);
        ...
        crate::draw::draw_text_sized(
            surface,
            x + w as i32 - crate::theme::scale_i32(18),
            y + y_pad,
            btn_color,
            b"+",
            fs,
        ...
        let sep_h = if h > (sep_pad as u32 * 2) {
            h - sep_pad as u32 * 2
        } else {
            1
        };
