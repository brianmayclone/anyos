...
impl Control for ColorWell {
    ...
    fn render(&self, surface: &crate::draw::Surface, ax: i32, ay: i32) {
        ...
        if p.w > 6 && p.h > 6 {
            crate::draw::fill_rounded_rect(surface, p.x + 3, p.y + 3, p.w - 6, p.h - 6, corner.saturating_sub(2), color);
            crate::draw::draw_rounded_border(surface, p.x + 3, p.y + 3, p.w - 6, p.h - 6, corner.saturating_sub(2), crate::theme::with_alpha(0xFFFFFFFF, 42));
        }
    }
