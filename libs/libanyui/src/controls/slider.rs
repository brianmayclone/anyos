use crate::control::{prepare_render, Control, ControlBase, ControlKind, EventResponse};
    ...
    fn render(&self, surface: &crate::draw::Surface, ax: i32, ay: i32) {
        ...
        if fill_w > 0 {
            ...
            crate::controls::chrome::draw_surface(
                ...
                crate::controls::chrome::accent_palette(accent, false, false, ctx.disabled),
            );
        }
        ...
        let thumb_palette = crate::controls::chrome::neutral_palette(
            ctx.hovered || self.dragging,
            self.dragging,
            ctx.disabled,
        );

        if ctx.focused && !ctx.disabled {
            crate::controls::chrome::draw_focus(
                surface,
                thumb_x,
                thumb_y,
                thumb_w,
