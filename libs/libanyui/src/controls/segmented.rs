...
impl Control for SegmentedControl {
    ...
    fn render(&self, surface: &crate::draw::Surface, ax: i32, ay: i32) {
        ...
        let shell = crate::controls::chrome::neutral_palette(ctx.hovered, false, ctx.disabled);
        ...
        for i in 0..n {
            ...
            if i == active {
                ...
                crate::controls::chrome::draw_surface(
                    ...
                    ah,
                    ar,
                    crate::controls::chrome::accent_palette(tc.accent, false, false, ctx.disabled),
                );
            }
