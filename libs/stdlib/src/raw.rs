...
pub(crate) const SYS_LICOF_SPAWN: u32 = 710;
...
pub(crate) const SYS_UPTIME_MS: u32 = 35;
pub(crate) const SYS_SET_TIME: u32 = 37;
...
pub(crate) const SYS_DISPLAY_GET_ROTATION: u32 = 706;
